...
%     app.StartupLogTextArea = uitextarea(app.UIFigure,'Position', [127,650,728,105]);
    ...
    for plate_num=1:length(app.plates)
      ...
      known_naming_schemes = {'OperettaSplitTiffs','ZeissSplitTiffs', 'SingleChannelFiles', 'XYZCT-Bio-Format-SingleFile','MultiChannelFiles','XYZ-Bio-Formats','XYZC-Bio-Formats','IncuCyte','CellomicsTiffs','IXMCTiffs'};
