function fun(app, createCallbackFcn)
  ...
  % plate_file = 'C:\Users\daniel snider\Dropbox\Kafri\Projects\GUI\daniel\Camilla_Plate_Map_no_experiments.xlsx';
  % if exist(plate_file)
  % app.ChooseplatemapEditField.Value = plate_file;
  % end
  % plate_file = 'R:Justin_SCeryl_Nucleolus_Plate_Map_20180129.xlsx';
  % if exist(plate_file)
  %   app.ChooseplatemapEditField.Value = plate_file;
  % end
