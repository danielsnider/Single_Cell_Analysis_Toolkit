function [global_cell_index] = find_index(ResultsTable, timepoint, traceUsed, cell_index_within_local_table, varargin)
  ...
  if length(varargin)==1
      SubsetTable = ResultsTable.Timepoint==timepoint & ResultsTable.TraceUsed==traceUsed & strcmp(ResultsTable.Trace,varargin(1));
  else
      SubsetTable = ResultsTable.Timepoint==timepoint & ResultsTable.TraceUsed==traceUsed;
  end
