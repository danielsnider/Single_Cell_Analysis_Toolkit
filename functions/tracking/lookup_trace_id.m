function [trace global_cell_index] = find_trace(ResultsTable, timepoint, cell_index_within_timepoint, time_column_name)
  % Find the trace and global index for a cell in a ResultsTable at an index within a timepoint
  SubsetTable = ResultsTable.(time_column_name)==timepoint;
